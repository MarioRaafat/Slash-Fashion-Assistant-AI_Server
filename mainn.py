...
def load_csv_data():
    csv_data = {}
    try:
        csv_data['tags'] = pd.read_csv("database/tags.csv").to_dict(orient="records")
        csv_data['categories'] = pd.read_csv("database/category.csv").to_dict(orient="records")
        csv_data['colors'] = pd.read_csv("database/colours.csv").to_dict(orient="records")
        csv_data['brands'] = pd.read_csv("database/brands.csv").to_dict(orient="records")
        csv_data['products'] = pd.read_csv("database/products.csv").to_dict(orient="records")
